...
import { AlbumContext } from '../context/AlbümContext';
  ...
  return (
    ...
    <View style={styles.header}>
      <View style={styles.headerContent}>
        ...
        <Text style={styles.headerText}> Rasime Dumlupunar</Text>
      </View>
    ...
    <View>
      ...
      style={styles.likedSongs}>
        <LinearGradient colors={[ "#1AD35E","#11035E"]} style={{borderRadius:30}}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        {artists?.slice().reverse().map((artist, index) => (
